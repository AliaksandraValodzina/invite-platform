...
**Not in Phase 0:** payments, seller accounts, marketplace, freemium, custom domains, photo sharing. Filling a template in is built (`docs/editing.md`); adding, removing or moving sections is not. Activation is built (`docs/activation.md`): a claim link mints the buyer's copy, and publish and unpublish work.
